      ...
      */
      ...
      if (strcmp(string1,"built_in") == 0) {
        ...
        /* Check first if injection history is standard and already implemented */
                ...
                /* Automatic comand for annihialtion with halo boost for EMDE cases */
        if(pth->annihilation > 0 && pth->cut_ratio > 0){
          fprintf(stdout,"Making DarkAges command with pth->cut_ratio = %.2e in line 1703 of input.c. \n",pth->cut_ratio);
